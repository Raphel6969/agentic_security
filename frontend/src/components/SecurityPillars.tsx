  ...
  const pillars = [
    {
      ...
      description: 'Sentinel analyzes incoming content and proposed actions using sub-millisecond regex rules and quantized semantic detection before anything reaches the underlying tool.',
      icon: Search,
    ...
    },
    {
      ...
      description: 'When automated detectors disagree or semantic confidence falls into an uncertain band, Sentinel selectively escalates the payload to an LLM security judge for deep intent arbitration.',
      icon: BrainCircuit,
    ...
    },
    {
      ...
      description: 'Allow, require human approval, or block. Sentinel returns a machine-readable verdict with cryptographically verifiable audit trails that the agent-side runtime executes.',
      icon: ShieldAlert,
